...
/**
    功能cell
 */
@interface KSSideslipCell : UITableViewCell <UIGestureRecognizerDelegate> 
...
@property (nonatomic) KSSideslipConfirmActionView *confirmActionView;//点击侧滑按钮后，若有需要持有用户返回的新View
